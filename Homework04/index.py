...
def draw(canvas):
    ...
    canvas.draw_text(str(scores1), (200, 60), 20, "Red")
    canvas.draw_text(str(scores2), (400, 60), 20, "Red")
    canvas.draw_line([WIDTH / 2, 0],[WIDTH / 2, HEIGHT], 1, "White")
    canvas.draw_line([PAD_WIDTH, 0],[PAD_WIDTH, HEIGHT], 1, "White")
    canvas.draw_line([WIDTH - PAD_WIDTH, 0],[WIDTH - PAD_WIDTH, HEIGHT], 1, "White")

    canvas.draw_polygon([[0, PAD1_POS], [PAD_WIDTH, PAD1_POS],[PAD_WIDTH, 
                                                          (PAD1_POS) + PAD_HEIGHT ],[0, (PAD1_POS) 
                                                          + PAD_HEIGHT]],1, "White", "White") 
    canvas.draw_polygon([[WIDTH, PAD2_POS], [WIDTH - PAD_WIDTH, PAD2_POS],
                    [WIDTH - PAD_WIDTH, PAD2_POS + PAD_HEIGHT], 
                    [WIDTH, PAD2_POS + PAD_HEIGHT]],1, "White", "White")
